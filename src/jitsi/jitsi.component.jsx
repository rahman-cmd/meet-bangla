...
class JitsiComponent extends Component {
    ...
    handleVideoConferenceJoined = async (participant) => {
        console.log("handleVideoConferenceJoined", participant); // { roomName: "khulna studay group", id: "8c35a951", displayName: "Andur Rahman", formattedDisplayName: "Andur Rahman (me)"}
        const data = await this.getParticipants();
    }
